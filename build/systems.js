...
import { Matrix3, getRandomMatrix3 } from "./matrix.js";
...
export class AugmentedRow3 {
    ...
    replaceElement(column, replaceWith) {
...
export class AugmentedMatrix3 {
    ...
    getConstantColumn() {
        return new Vector3(this.a4, this.b4, this.c4);
    }
    hasZeroRow() {
...
export function generateInfiniteSolutionsExercise(max = 10) {
