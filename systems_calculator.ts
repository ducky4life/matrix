...
function getInputAugmentedMatrix(name: string): AugmentedMatrix3 {
    const a1 = Number((document.getElementById(`augmented_${name}_a1`) as HTMLInputElement).value);
    const a2 = Number((document.getElementById(`augmented_${name}_a2`) as HTMLInputElement).value);
    const a3 = Number((document.getElementById(`augmented_${name}_a3`) as HTMLInputElement).value);
    const a4 = Number((document.getElementById(`augmented_${name}_a4`) as HTMLInputElement).value);
    const b1 = Number((document.getElementById(`augmented_${name}_b1`) as HTMLInputElement).value);
    const b2 = Number((document.getElementById(`augmented_${name}_b2`) as HTMLInputElement).value);
    const b3 = Number((document.getElementById(`augmented_${name}_b3`) as HTMLInputElement).value);
    const b4 = Number((document.getElementById(`augmented_${name}_b4`) as HTMLInputElement).value);
    const c1 = Number((document.getElementById(`augmented_${name}_c1`) as HTMLInputElement).value);
    const c2 = Number((document.getElementById(`augmented_${name}_c2`) as HTMLInputElement).value);
    const c3 = Number((document.getElementById(`augmented_${name}_c3`) as HTMLInputElement).value);
...
function setSolutionAmountEventListener() {
    const operationElement = (document.getElementById('solution_amount') as HTMLSelectElement);
    operationElement.addEventListener('input', () => {
        randomiseInput();
    })
}

function ensureSolutionAmount(): AugmentedMatrix3 {
    let solution_amount = Number((document.getElementById('solution_amount') as HTMLSelectElement).value);
