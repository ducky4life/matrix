...
export class Vector3 {
    ...
    angleWithPlaneInDegrees(P: Plane): number {
    ...
    isCoplanarWith(P: Plane): boolean {
        const normalVector = P.normalVector();
        return (this.isPerpendicularTo(normalVector));
    }

    getNormalProjectionToPlane(P: Plane): Vector3 {
    ...
    getVectorToProjectionOnPlane(P: Plane): Vector3 {
...
export function getRandomVector2(max: number = 10) {
...
export function getRandomVector3(max: number = 10) {
...
export function volumeOfIncludedTetrahedron(V1: Vector3, V2: Vector3, V3: Vector3): number {
    const VA = V1;
    const VB = V2;
    const VC = V3;
...
export function volumeOfTetrahedron(V1: Vector3, V2: Vector3, V3: Vector3, V4: Vector3): number {
    const V = V1;
    const A = V2;
    const B = V3;
    const C = V4;
