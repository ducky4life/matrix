...
import { generateNumberExercise, generateVectorExercise, numberRoughlyEquals, Plane, Vector3 } from "./vector.js";
...
function clearVectorInput(name: string) {
...
function clearNumberInput(name: string) {
